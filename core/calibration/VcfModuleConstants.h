...
//
// core/calibration/VcfModuleConstants.h — the (PI) DESIGN-UNIT layout constants for
// ui/modules/VcfModule (task 122). The module lays its children out in design units
...
// Cutoff, Resonance, Env Mod (env amount), Keyboard Track, VCF LFO Mod
// [docs/design/10-ui.md §5.3 VCF row].

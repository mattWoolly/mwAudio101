...
//
// core/calibration/VcaModuleConstants.h — the (PI) DESIGN-UNIT layout constants for
// ui/modules/VcaModule (task 123). The module lays its children out in design units
...
// retune the module's internal proportions in one place. This is a NEW header (NOT the
// orchestrator-owned core/calibration/Calibration.h) so parallel UI/DSP work does not
// collide on the shared aggregate.
//
...
// VCA Mode (env/gate select), VCA Level, then the shared envelope A / D / S / R.

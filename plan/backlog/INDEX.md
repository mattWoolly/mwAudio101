...
| 8 | 045 | bless tool — arm64-only, BLESS_REASON-gated guarded writer | qa | M | 001, 006, 047, 044 | todo |
| 8 | 073 | Voice.h/.cpp — circuit-accurate signal-path assembly + drift seed | core | M | 001, 006, 007, 067, 068, 032, 047, 062 | todo |
...
| 14 | 117 | ModuleBase + ModulatorModule (LFO/S&H + mod depth) with APVTS attachments | ui | M | 020, 111, 006, 106, 108, 109 | todo |
...
| 15 | 120 | VcoModule (range, waveform mix, PWM, pitch, sub, noise) | ui | M | 020, 111, 006, 109, 117 | todo |
| 15 | 121 | SourceMixerModule (saw/pulse/sub/noise levels) | ui | S | 020, 111, 006, 109, 117 | todo |
| 15 | 122 | VcfModule (cutoff, resonance, env amount, kbd track, mod) | ui | S | 020, 111, 006, 109, 117 | todo |
| 15 | 123 | VcaModule (env/gate select, level, env A/D/S/R) | ui | S | 020, 111, 006, 109, 117 | todo |
| 15 | 124 | ControllerStrip (glide, bend, mod-wheel routing, transpose) | ui | S | 020, 111, 006, 109, 117 | todo |
| 15 | 125 | TransportModeBar (arp/seq mode, tempo-sync, run/hold, scale + reduce-motion toggles) | ui | M | 020, 111, 087, 006, 109, 117 | todo |
...
| 15 | 136 | Wire MwAudioProcessor: engine + frontend + capability shim + latency reporter | app | M | 111, 104, 113, 020, 118 | todo |
